    ...
    <div className="relative min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 dark:bg-slate-950 dark:text-slate-200">
      ...
      <nav className="relative z-40 w-full max-w-6xl mx-auto px-6 py-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/login"
            className="text-sm font-medium px-5 py-2.5 rounded-full border border-slate-300 bg-white text-slate-700 shadow-sm hover:bg-slate-50 transition-colors dark:border-slate-700 dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
